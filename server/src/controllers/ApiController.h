...
public:
    METHOD_LIST_BEGIN
        ...
        ADD_METHOD_TO(ApiController::logoutAll, "/api/logoutall", drogon::Post, "JwtFilter");
    ...
    static drogon::Task<drogon::HttpResponsePtr> logoutAll(drogon::HttpRequestPtr req);
